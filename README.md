...
Для использования должны быть установлены следующие компоненты: на сервере ядро sudoku ([скрипт быстрой установки](https://github.com/SUDOKU-ASCII/easy-install)), клиент под андроид ([sudodroid](https://github.com/SUDOKU-ASCII/sudoku-android)) и клиент под другие платформы из основного репозитория - [SUDOKU-ASCII](https://github.com/SUDOKU-ASCII/sudoku).<br>
